...
snarkjs zkey contribute circuit_0000.zkey circuit_0001.zkey --name="Frist contribution" -v -e="Random entropy"
snarkjs zkey contribute circuit_0001.zkey circuit_0002.zkey --name="Second contribution" -v -e="Another random entropy"
